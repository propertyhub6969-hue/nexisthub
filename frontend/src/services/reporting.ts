...
export const reportingService = {
  ...
  async positionDetail(kind: string): Promise<PositionDetail> {
    const { data } = await api.get<PositionDetail>('/reporting/financial-position/detail', { params: { kind } })
    return data
  },
