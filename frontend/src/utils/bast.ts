...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .logo { width: 60px; height: 60px; border: 1px dashed #bbb; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-size: 8px; color: #999; text-align: center; }
