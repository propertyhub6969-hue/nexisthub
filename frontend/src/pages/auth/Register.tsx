...
export default function Register() {
  ...
  // Antar otomatis ke alamat Kantor Digital-nya sendiri — sesi tak bisa dibawa lintas origin, jadi mereka masuk sekali di sana
  useEffect(() => {
    if (!homeUrl) return
        ...
        <div className="w-full max-w-sm">
          {doneSlug !== undefined ? (
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-slate-900">Kantor Digital Anda siap</h1>
