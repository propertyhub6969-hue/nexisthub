...
from app.api.v1.endpoints import notification, auth, users, marketing, property, sale, payment, audit, tax, document, kpr, procurement, stock, expense, rab, construction, contractor, legal, reporting, filing, platform, public, billing, cashbook, import_data, announcement
...
api_router.include_router(import_data.router,  prefix="/import",      tags=["Import"],      dependencies=[feat("properti"), g(UserRole.OWNER, UserRole.ADMIN, UserRole.MANAGER)])
