...
api_router.include_router(marketing.router,   prefix="/marketing",   tags=["Marketing"],   dependencies=[feat("marketing"), g(*SALES, read=(V,))])
api_router.include_router(property.router,    prefix="/property",    tags=["Property"],    dependencies=[feat("properti"), g(*SALES, read=(UserRole.PRODUKSI, V))])
api_router.include_router(sale.router,         prefix="/sales",       tags=["Sales"],       dependencies=[g(*SALES, read=(V,))])
api_router.include_router(payment.router,      prefix="/payments",    tags=["Payments"],    dependencies=[feat("pembayaran"), g(*SALES, read=(V,))])
api_router.include_router(audit.router,        prefix="/audit",       tags=["Audit"],       dependencies=[g(*FULL, read=(UserRole.MARKETING, UserRole.PRODUKSI, V))])
...
api_router.include_router(reporting.router,   prefix="/reporting",   tags=["Reporting"],   dependencies=[feat("laporan"), g(*FULL, read=(UserRole.MARKETING, UserRole.PRODUKSI, V))])
